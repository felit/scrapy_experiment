...
def main(scel_filename,output_filename):
    # if (len(sys.argv) < 3):
...
if __name__ == '__main__':
    ...
    #将要转换的词库添加在这里就可以了
    # sys.exit(main('/data/source/self/scrapy_experiment/token/dota.scel','/data/source/self/scrapy_experiment/token/dota.txt'))
    sys.exit(main('/data/source/self/scrapy_experiment/token/agriculture.scel','/data/source/self/scrapy_experiment/token/agriculture.txt'))